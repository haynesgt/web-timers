...
})({"dJRq0":[function(require,module,exports) {
...
window._ = (0, _lodashDefault.default);
window.preact = _preact;
const appElement = document.getElementById("app");
_preact.render(/*#__PURE__*/ _preact.createElement((0, _appDefault.default), {
    __source: {
...
},{"preact":"5fsG1","lodash":"fAiEq","./App":"7F5Te","./index.css":"irmnC","@parcel/transformer-js/src/esmodule-helpers.js":"fF8Uh"}],"5fsG1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"fAiEq":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
function TimerRow({ timer, dispatch, state }) {
    function onDragEnd(e) {
        ...
        let newOrder = timerIds.flatMap((id)=>id === timer?.id ? [] : id == destId ? before ? [
                timer?.id,
                id
            ] : [
                id,
        ...
        dispatch({
            reorder: newOrder.filter((id)=>id !== undefined)
        });
    }
    return /*#__PURE__*/ preact.createElement("tr", {
        className: "timer-row",
        draggable: true,
        ...
        __self: this
    }, /*#__PURE__*/ preact.createElement("td", {
        __source: {
            fileName: "src/App.tsx",
            lineNumber: 32,
            columnNumber: 7
        ...
        __self: this
    }, timer?.isRunning ? timer?.newTimeLimit !== undefined ? timer?.newTimeLimit : (0, _formatTimeDefault.default)(timer?.timeLimitMs || 0) : /*#__PURE__*/ preact.createElement(LiveInput, {
        placeholder: "0m0s",
        value: timer?.newTimeLimit !== undefined ? timer?.newTimeLimit : (0, _formatTimeDefault.default)(timer?.timeLimitMs || 0),
        ...
        __self: this
    }, timer?.isRunning ? (0, _formatTimeDefault.default)(timer?.timeRemainingMs || 0) : /*#__PURE__*/ preact.createElement(LiveInput, {
        value: timer?.newTimeRemaining || (0, _formatTimeDefault.default)(timer?.timeRemainingMs || 0),
        setValue: (value)=>dispatch?.({
                updateTimer: {
                    id: timer.id,
        ...
        __self: this
    }, "\xa0", /*#__PURE__*/ preact.createElement(TimerButtonGroup, {
        timer: timer,
        dispatch: dispatch,
        __source: {
            fileName: "src/App.tsx",
...
function TimerButtonGroup({ timer, dispatch }) {
    function resetTimer() {
        dispatch?.({
            updateTimer: {
                id: timer?.id,
    ...
    return /*#__PURE__*/ preact.createElement("div", {
        ...
        __self: this
    }, /*#__PURE__*/ preact.createElement("button", {
        onClick: resetTimer,
        disabled: timer?.timeLimitMs === timer?.timeRemainingMs,
        __source: {
            fileName: "src/App.tsx",
            lineNumber: 116,
            columnNumber: 7
        ...
        __self: this
    }, "v"), /*#__PURE__*/ preact.createElement("button", {
        onClick: deleteTimer,
        disabled: false,
        __source: {
            fileName: "src/App.tsx",
...
function LiveInput({ value, setValue, onSubmit, ...props }) {
    function onEvent(e) {
        if (setValue) setValue(e?.currentTarget?.value || "");
        if (e.type == "keydown" && e?.key === "Enter" && onSubmit) onSubmit();
    }
    return /*#__PURE__*/ preact.createElement("input", {
        type: "text",
        value: value,
        onInput: onEvent,
        onKeyUp: onEvent,
...
class Notifier {
    setNotifying(id, notifying, message) {
        const wasNotifying = this.notifyingStatusById.get(id);
        if (wasNotifying === notifying) return;
        if (notifying) new Notification(message);
        this.notifyingStatusById.set(id, notifying);
    }
    constructor(){
        this.notifyingStatusById = new Map();
    }
}
const notifier = new Notifier();
function App() {
    const [state, dispatch] = (0, _hooks.useReducer)((0, _reducer.reducer), {});
    ...
    (0, _hooks.useEffect)(()=>{
        state.timers?.forEach((timer)=>{
            if (timer) notifier.setNotifying(timer.id, timer.isNotifying || false, "Timer done: " + (0, _formatTimeDefault.default)(timer.timeLimitMs || 0));
        });
    }, [
        state
    ]);
    return /*#__PURE__*/ preact.createElement("div", {
        ...
        __self: this
    }, /*#__PURE__*/ preact.createElement("table", {
        ...
        __self: this
    }, /*#__PURE__*/ preact.createElement("tr", {
        __source: {
            fileName: "src/App.tsx",
            lineNumber: 228,
            columnNumber: 11
        ...
        __self: this
    }, /*#__PURE__*/ preact.createElement("th", {
        __source: {
            fileName: "src/App.tsx",
            lineNumber: 229,
            columnNumber: 13
        ...
        __self: this
    }, "Limit"), /*#__PURE__*/ preact.createElement("th", {
        __source: {
            fileName: "src/App.tsx",
            lineNumber: 230,
            columnNumber: 13
        ...
        __self: this
    }, "Remiaining"), /*#__PURE__*/ preact.createElement("th", {
        __source: {
            fileName: "src/App.tsx",
            lineNumber: 231,
            columnNumber: 13
        ...
        __self: this
    }, "Actions")), state.timers?.map((timer)=>{
        return /*#__PURE__*/ preact.createElement(TimerRow, {
            key: timer?.id,
            state: state,
            timer: timer,
            dispatch: dispatch,
        ...
        __self: this
    }, "\xa0", /*#__PURE__*/ preact.createElement("div", {
        className: "button-group",
        __source: {
            fileName: "src/App.tsx",
            lineNumber: 243,
...
},{"preact/hooks":"4GfQp","./formatTime":"ejnjn","./reducer":"jagDJ","@parcel/transformer-js/src/esmodule-helpers.js":"fF8Uh"}],"4GfQp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"preact":"5fsG1","@parcel/transformer-js/src/esmodule-helpers.js":"fF8Uh"}],"ejnjn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>formatTime);
function formatTime(ms, short = false) {
    ...
    if (ms >= 0.001 || !short) str += `.${Math.round(nextMs).toString().padStart(3, "0")}`;
    if (str[0] === "0") str = str.slice(1);
    if (negative) str = "-" + str;
    return str;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"fF8Uh"}],"jagDJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "newId", ()=>newId);
parcelHelpers.export(exports, "reducer", ()=>reducer);
var _parseTime = require("./parseTime");
var _parseTimeDefault = parcelHelpers.interopDefault(_parseTime);
var _formatTime = require("./formatTime");
var _formatTimeDefault = parcelHelpers.interopDefault(_formatTime);
function newId() {
    return Math.floor(Math.random() * 2 ** 64).toString(16).padStart(16, "0");
}
function getNewTimer(state) {
    const timeLimitMs = (0, _parseTimeDefault.default)(state?.newTimerForm?.newTime || "");
    return {
        id: newId(),
...
function updateTimerAt(timer, updateAt) {
    ...
    return {
        ...
        newTimeRemaining: (0, _formatTimeDefault.default)(nextTimeRemainingMs),
...
function reducer(state, action) {
    if (action.setState !== undefined) return action.setState;
    if (action.setNewTimerText !== undefined) return {
        ...state,
        newTimerForm: {
            newTime: action.setNewTimerText
        }
    };
    if (action.addTimerTop) return {
        ...state,
        newTimerForm: {
            newTime: ""
        },
    ...
    if (action.updateAt) return {
        ...state,
        timers: (state.timers || []).map((timer)=>updateTimerAt(timer, action.updateAt))
    };
    if (action.updateTimer) return {
        ...state,
        timers: (state.timers || []).flatMap((timer)=>{
            return timer.id === action.updateTimer?.id ? [
                {
                    ...timer,
                    confirmDelete: false,
                    ...action.updateTimer?.newTimeLimit !== undefined ? {
                        newTimeLimit: action.updateTimer?.newTimeLimit,
                        timeLimitMs: (0, _parseTimeDefault.default)(action.updateTimer?.newTimeLimit),
                        timeRemainingMs: (0, _parseTimeDefault.default)(action.updateTimer?.newTimeLimit),
                        newTimeRemaining: (0, _formatTimeDefault.default)((0, _parseTimeDefault.default)(action.updateTimer?.newTimeLimit))
                    } : {},
                    ...action.updateTimer?.newTimeRemaining !== undefined ? {
                        newTimeRemaining: action.updateTimer?.newTimeRemaining,
                        timeRemainingMs: (0, _parseTimeDefault.default)(action.updateTimer?.newTimeRemaining)
                    } : {},
                    ...action.updateTimer?.reset ? {
                        timeRemainingMs: timer.timeLimitMs,
                        newTimeRemaining: (0, _formatTimeDefault.default)(timer.timeLimitMs || 0),
                        isNotifying: false
                    } : {},
                    ...
                    ...action.updateTimer?.pause ? {
                        isRunning: false,
                        newTimeRemaining: (0, _formatTimeDefault.default)(timer.timeRemainingMs || 0),
                        isNotifying: false
                    } : {},
...
},{"./parseTime":"2cXvo","./formatTime":"ejnjn","@parcel/transformer-js/src/esmodule-helpers.js":"fF8Uh"}],"2cXvo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>parseTime);
function parseTime(timeStr) {
    let nextStr = timeStr;
    let ms = 0.0;
    let nextNumberOfNumbers = timeStr.match(/\d+(\.\d+)?/g)?.length || 0;
    const minusMatch = nextStr.match(/^\s*-\s*(?<next>.*)$/);
    if (minusMatch) nextStr = minusMatch.groups?.next || "";
    while(nextStr){
        ...
        if (numberMatch) {
            ...
            if (unitMatch) {
                ...
                if (unit.startsWith("ms") || unit.startsWith("mil")) ms += number;
                else if (unit[0] === "d") ms += number * 86400000;
                else if (unit[0] === "h") ms += number * 3600000;
                else if (unit[0] === "m") ms += number * 60000;
                else if (unit[0] === "s") ms += number * 1000;
                else // console.log("!", number, nextNumberOfNumbers, unitMatch);
                ms += number * 1000 * 60 ** Math.min(2, nextNumberOfNumbers - 1) * (nextNumberOfNumbers > 3 ? 24 : 1);
                nextNumberOfNumbers -= 1;
            }
        } else nextStr = nextStr.slice(1);
    }
    return ms * (minusMatch ? -1 : 1);
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"fF8Uh"}],"irmnC":[function() {},{}]},["dJRq0","4aBH6"], "4aBH6", "parcelRequire94c2")
